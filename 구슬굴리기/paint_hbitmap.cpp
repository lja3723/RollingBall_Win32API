...
// 
//////////////////////////////////////////
Paint_hBitmap::_windowBuffer::_old::operator HBITMAP()
{
	return m_windowBuffer;
}
void Paint_hBitmap::_windowBuffer::_old::operator=(HBITMAP hBitmap)
{
...
Paint_hBitmap::_windowBuffer::operator HBITMAP()
{
	return m_windowBuffer;
}
...
// 
//////////////////////////////////////
HBITMAP& Paint_hBitmap::_res::_old::operator()(int idx)
{
...
void Paint_hBitmap::_res::isBackedUp(BOOL flag)
{
...
size_t Paint_hBitmap::_res::size()
{
	return m_res.size();
}
const HBITMAP& Paint_hBitmap::_res::operator()(int idx)
{
	if (!(0 <= idx && idx < m_res.size())) idx = 0;
	return m_res[idx];
}
